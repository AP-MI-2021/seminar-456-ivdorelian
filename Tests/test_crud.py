...
def get_data():
    return [
        creeaza_prajitura(1, 'p1', 'desc 1', 100, 50, 2018),
        creeaza_prajitura(2, 'p2', 'desc 2', 60.7, 80.32, 2015),
        creeaza_prajitura(3, 'p3', 'desc 3', 0, 20, 2012),
        creeaza_prajitura(4, 'p4', 'desc 4', 153534, 150, 2017),
        creeaza_prajitura(5, 'p5', 'desc 5', 40.7775, 40.32, 2016),
   ]
